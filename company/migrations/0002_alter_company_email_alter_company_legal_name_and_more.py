...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='company',
            name='logo',
            field=models.ImageField(blank=True, height_field='url_height', null=True, upload_to=image.models.user_directory_path, validators=[company.business_logic.validate_image_size], width_field='url_width'),
        ),
    ]
