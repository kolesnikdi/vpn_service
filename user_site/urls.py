...
from user_site.views import UserSiteView, GoToSiteView, UserSiteStatisticsView, TakeSiteAndRepresentView, vpn_service

urlpatterns = [
    path('site/new/', UserSiteView.as_view(), name='create_site'),
    # path('<str:name>/', GoToSiteView.as_view(), name='user_site'),
