    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, height_field='url_height', null=True, upload_to=image.models.user_directory_path, validators=[location.business_logic.validate_image_size], width_field='url_width')),
